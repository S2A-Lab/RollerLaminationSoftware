...
class PlotUpdateModule(QObject):
    ...
    def __init__(self, data_logger_module: DataLoggerScheduler, ui_interface: UIInterface):
        super().__init__()
    ...
    def run(self):
        ...
        self.ui_interface.update_plot(self.data_logger_module.target_position_data[0], self.data_logger_module.feedback_data[0],
                                      self.data_logger_module.target_position_data[1], self.data_logger_module.feedback_data[1])
        self.ui_interface.update_y_limits(self.data_logger_module.lb, self.data_logger_module.ub)
        if self.data_logger_module.target_position_data[0].data.__len__() > 0:
